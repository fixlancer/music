...
const PlayNotification = ({navigation, route}) => {
...
<IconM
        ...
        <View
          ...
          <View style={[styles.Row, { justifyContent: 'center', alignItems: 'center', marginTop: 10, }]}>
            <Text style={[styles.subLabel, { marginRight: 10, fontSize: RFValue(11), color: '#565555' }]}>{stream} streams</Text>
        ...
        <View style={{ paddingBottom: 30, paddingHorizontal: 15 }}>
          ...
          <TouchableOpacity
              onPress={() =>navigation.navigate('Profile', {userID: '3456'})}>
